                ...
                <div className="container ">
                    <div className="row  justify-content-center align-items-center ">
                        <div data-aos="fade-right" className="col-md-6">
                            <h1 className={BodyStyle.heading}><span className="color">Track </span> your Device <br /> Quality </h1>
                        ...
                        <div data-aos="zoom-in" className="col-md-6">
                            <img className={`${BodyStyle.img}   w-100`} src="https://5.imimg.com/data5/EB/VS/FA/SELLER-57460647/huawei-mobile-phones-500x500.png" alt="" />
