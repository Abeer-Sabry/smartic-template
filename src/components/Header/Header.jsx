                ...
                <div className="container">
                    <div className="row d-flex align-items-center ">
                        ...
                        <div className="col-md-6  position-relative">
                            ...
                            <img className={headStyle.img} data-aos="fade-left" data-aos-delay="500" className={`${headStyle.position}   w-100`} src="https://demo2.wpopal.com/smartic/wp-content/uploads/2020/09/08_product_1-500x525.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
